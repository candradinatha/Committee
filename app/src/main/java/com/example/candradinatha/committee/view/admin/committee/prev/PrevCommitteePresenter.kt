...
class PrevCommitteePresenter(val mView: PrevCommitteeContract.View, val apiService: ApiInterface, val schedulers: SchedulersProvider): PrevCommitteeContract.Presenter {
